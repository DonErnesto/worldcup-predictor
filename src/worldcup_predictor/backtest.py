...
PREDICTORS = {
    ...
    "expected_points_phase_split_poisson": ExpectedPointsPhaseSplitScorePredictor,
    "goal_average_mode_score_phase_split_poisson": GoalAverageModeScorePhaseSplitScorePredictor,
