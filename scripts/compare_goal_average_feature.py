...
from worldcup_predictor.model import GoalAverageModeScorePhaseSplitScorePredictor, ModeScorePhaseSplitScorePredictor
...
EXPERIMENTS: dict[str, Callable[[], object]] = {
    ...
    "goal_average_mode_score_phase_split_poisson_alpha_0_1": lambda: GoalAverageModeScorePhaseSplitScorePredictor(
        alpha=ALPHA
    ),
}
...
def main() -> None:
    ...
    predictions.to_csv(output_dir / "goal_average_feature_predictions.csv", index=False)
    summary_by_year.to_csv(output_dir / "goal_average_feature_summary_by_year.csv", index=False)
    summary_overall.to_csv(output_dir / "goal_average_feature_comparison.csv", index=False)
